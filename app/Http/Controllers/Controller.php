...
class Controller extends BaseController
{
    ...
    public function index()
    {
        ...
        if ($this->isSchoolWebsiteRequest()) {
            ...
            return view('comingsoon', compact('features', 'packages', 'settings', 'faqs', 'guidances', 'languages', 'schoolSettings', 'featureSections', 'about_us_lists', 'counter', 'trail_package', 'extraFields', 'demoSchoolUrl', 'allSchools', 'isDemoSchool'));
